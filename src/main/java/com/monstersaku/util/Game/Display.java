...
public class Display {
    ...
    public static void help() {
        ...
        System.out.println("Permainan ini berjenis Player vs Player (PvP) yang dapat dimainkan oleh 2 pemain yang saling berlawanan.");
        System.out.println("Masing-masing dari pemain akan menerima kombinasi 6 monster yang ditentukan secara acak oleh aplikasi pada setiap permainan.");
        ...
        System.out.println("4. Setiap pemain di setiap gilirannya dapat mengganti monster yang akan digunakan(switch) ataupun memilih movenya.");
        System.out.println("5. Move akan dieksekusi secara bergiliran berdasarkan prioritas dan speed dari masing-masing monster.");
    ...
    public static void helpTurn(){
        System.out.println("<<<>>> HELP <<<>>>");
        System.out.println("1. MOVE");
        System.out.println("Move merupakan aksi monster untuk menyerang monster lawan, heal, dll. Monster tidak dapat melakukan move jika status conditionnya 'SLEEP'.");
        System.out.println("2. SWITCH");
        System.out.println("Switch digunakan untuk mengganti monster yang akan bertarung dengan monster lain yang tersedia.");
        System.out.println("3. MONSTER INFO");
